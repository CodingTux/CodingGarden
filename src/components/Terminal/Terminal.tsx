...
function Terminal() {
  ...
  React.useEffect(() => {
    if (xtermRef) {
      ...
      // @ts-ignore: Object is possibly 'null'.
      xtermRef.current.terminal.writeln(
        "Welcome to coding garden terminal (Not connected with backend. Just need to establish socket connection that's it)"
      );
      // @ts-ignore: Object is possibly 'null'.
      xtermRef.current.terminal.writeln(
      ...
      // @ts-ignore: Object is possibly 'null'.
      xtermRef.current.terminal.write("(base) codingtux@codinggarden:~$");
